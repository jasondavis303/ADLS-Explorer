...
namespace ADLS_Explorer
{
    ...
    public class FontAwesome
    {
        ...
        private static string FONT_FILE_NAME
        {
            get
            {
                string path = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
                path = Path.Combine(path, "fontawesome-webfont-v4.7.0.ttf");
                return path;
            }
        }
    ...
    public static class FontAwesomeExtensions
    {
        ...
        public static Bitmap AsImage(this FontAwesome.Type type, Color color)
        {
            return new FontAwesome.Properties(type) { ForeColor = color }.AsImage();
        }
        ...
        public static Icon AsIcon(this FontAwesome.Type type, Color color)
        {
            return new FontAwesome.Properties(type) { ForeColor = color }.AsIcon();
        }
    }
}
